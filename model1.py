...
# Xây dựng mô hình mạng nơron CNN
...
# Huấn luyện mô hình
model.fit(input_sequences, encoded_labels, epochs=100)

# Lưu mô hình đã huấn luyện
model.save('chatbot_model_cnn.h5')
...
with open('label_encoder_cnn.pickle', 'wb') as handle:
